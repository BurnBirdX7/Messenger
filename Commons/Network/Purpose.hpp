    ...
    struct Purpose {
        ...
        enum to_server : uint8_t { // 0x20 .. 0xFF
         ...
         // ~ Basic authentication ~  // === [ 0x20 .. 0x27 ] =========== //
            ...
            RESTORE_SESSION   = 0x23, // session_id, session_hash         // ACCEPTED: user_id; DECLINED;
            REGISTER_USER     = 0x24, // login, password                  // ACCEPTED; DECLINED;
                                      //                                  //
         // ~ Basic info ~            // === [ 0x28 .. 0x2F ] =========== //
            GET_USER_ID       = 0x28, // user_name                        // ACCEPTED: user_id; DECLINED;
            ...
            GET_DCHAT_BY_ID   = 0x2C, // user_id                          // ACCEPTED: chat_info; DECLINED: reason;
            GET_DCHAT_BY_NAME = 0x2D, // user_name                        // ACCEPTED: chat_info; DECLINED: reason;
                                      //                                  //
         // ~ Work with chats ~       // === [ 0x30 .. 0x3F ] =========== //
            ...
            CREATE_CHAT       = 0x32, // chat_name [, password]           // ACCEPTED: chat_info; DECLINED: reason;
            START_CHAT        = 0x33, // user_id                          // ACCEPTED: chat_info; DECLINED: reason;
         ...
         // ~ Advanced Info ~         // === [ 0x48 .. 0x4F ] =========== //
            ...
            GET_USR_DATA_NAME = 0x49, // user_name                        // ACCEPTED: user_public_data; DECLINED: reason
            GET_USR_PR_DATA   = 0x4A, // -                                // ACCEPTED: user_private_data; DECLINED: reason;
            GET_SESSIONS      = 0x4B, // -                                // ACCEPTED: user_session_pack; DECLINED: reason;
